...
const s$1=globalThis.Headers,i$1=globalThis.AbortController,l$2=globalThis.fetch||(()=>{throw new Error("[node-fetch-native] Failed to fetch: `globalThis.fetch` is not available!")});
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/nattawutr./dormitory-management-information-system-web/.data/kv"}));
...
const appConfig = {"name":"vinxi","routers":[{"name":"public","type":"static","dir":"./public","base":"/","root":"/Users/nattawutr./dormitory-management-information-system-web","order":0,"outDir":"/Users/nattawutr./dormitory-management-information-system-web/.vinxi/build/public"},{"name":"client","type":"client","target":"browser","handler":"app/client.tsx","base":"/_build","build":{"sourcemap":true},"root":"/Users/nattawutr./dormitory-management-information-system-web","outDir":"/Users/nattawutr./dormitory-management-information-system-web/.vinxi/build/client","order":1},{"name":"ssr","type":"http","target":"server","handler":"app/ssr.tsx","link":{"client":"client"},"root":"/Users/nattawutr./dormitory-management-information-system-web","base":"/","outDir":"/Users/nattawutr./dormitory-management-information-system-web/.vinxi/build/ssr","order":2},{"name":"server","type":"http","target":"server","base":"/_server","handler":"node_modules/@tanstack/start/dist/esm/server-handler/index.js","root":"/Users/nattawutr./dormitory-management-information-system-web","outDir":"/Users/nattawutr./dormitory-management-information-system-web/.vinxi/build/server","order":3}],"server":{"preset":"vercel","experimental":{"asyncContext":true}},"root":"/Users/nattawutr./dormitory-management-information-system-web"};
				const buildManifest = {"client":{"_client-CeGHaAMR.js":{"file":"assets/client-CeGHaAMR.js","name":"client","dynamicImports":["app/routes/index.tsx?tsr-split","app/routes/index.tsx?tsr-split"]},"app/routes/index.tsx?tsr-split":{"file":"assets/index-CEkSuytU.js","name":"index","src":"app/routes/index.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-CeGHaAMR.js"]},"virtual:$vinxi/handler/client":{"file":"assets/client-_aV0kvq-.js","name":"client","src":"virtual:$vinxi/handler/client","isEntry":true,"imports":["_client-CeGHaAMR.js"]}},"ssr":{"_ssr-BLrUNRXs.js":{"file":"assets/ssr-BLrUNRXs.js","name":"ssr","dynamicImports":["app/routes/index.tsx?tsr-split","app/routes/index.tsx?tsr-split"]},"app/routes/index.tsx?tsr-split":{"file":"assets/index-VUlDrTel.js","name":"index","src":"app/routes/index.tsx?tsr-split","isDynamicEntry":true,"imports":["_ssr-BLrUNRXs.js"]},"virtual:$vinxi/handler/ssr":{"file":"ssr.js","name":"ssr","src":"virtual:$vinxi/handler/ssr","isEntry":true,"imports":["_ssr-BLrUNRXs.js"]}},"server":{"app/routes/index.tsx?tsr-split":{"file":"c_1wfb23.mjs","name":"c_1wfb23","src":"app/routes/index.tsx?tsr-split","isEntry":true},"virtual:$vinxi/handler/server":{"file":"entry.mjs","name":"entry","src":"virtual:$vinxi/handler/server","isEntry":true}}};
...
function i(e,t,n){return Object.assign(e,{url:"https://localhost:3000"})}function c(e,t){const n=t;return b$2(n.url,"createServerFn must be called with a function that is marked with the 'use server' pragma. Are you using the @tanstack/router-plugin/vite ?"),Object.assign(async(o,r)=>n({method:e,payload:o||void 0,requestInit:r?.requestInit}),{url:t.url})}const b$1=()=>Promise.resolve().then(()=>d),w=()=>Promise.resolve().then(()=>d),s=createFileRoute("/")({component:lazyRouteComponent(w,"component",()=>s.ssr),loader:lazyFn(b$1,"loader")}),u="count.txt";async function l$1(){return parseInt(await a$1.promises.readFile(u,"utf-8").catch(()=>"0"))}const F=c("GET",i(m)),C$1=c("POST",i(p$1)),S$1=function(){const t=useRouter(),n=s.useLoaderData();return jsxs("button",{onClick:()=>{C$1(1).then(()=>{t.invalidate();});},children:["Add 1 to ",n,"?"]})},j$1=async()=>await F();function m(){return l$1()}async function p$1(e){const t=await l$1();await a$1.promises.writeFile(u,`${t+e}`);}const d=Object.freeze(Object.defineProperty({__proto__:null,$$function0:m,$$function1:p$1,component:S$1,loader:j$1},Symbol.toStringTag,{value:"Module"}));
...
function P$1(e){let n;const t=T$1(e),s={duplex:"half",method:e.method,headers:e.headers};return e.node.req.body instanceof ArrayBuffer?new Request(t,{...s,body:e.node.req.body}):new Request(t,{...s,get body(){return n||(n=q(e),n)}})}function j(e){return e.web??={request:P$1(e),url:T$1(e)},e.web.request}function I$1(){return b()}const S=Symbol("$HTTPEvent");function U(e){return typeof e=="object"&&(e instanceof H3Event||e?.[S]instanceof H3Event||e?.__is_event__===!0)}function y(e){return function(...n){let t=n[0];if(U(t))n[0]=t instanceof H3Event||t.__is_event__?t:t[S];else {if(!globalThis.app.config.server.experimental?.asyncContext)throw new Error("AsyncLocalStorage was not enabled. Use the `server.experimental.asyncContext: true` option in your app configuration to enable it. Or, pass the instance of HTTPEvent that you have as the first argument to the function.");if(t=I$1(),!t)throw new Error("No HTTPEvent found in AsyncLocalStorage. Make sure you are using the function within the server runtime.");n.unshift(t);}return e(...n)}}const T$1=y(getRequestURL),W$1=y(getResponseStatus),q=y(getRequestWebStream);function J(){return getContext("nitro-app",{asyncContext:!!globalThis.app.config.server.experimental?.asyncContext,AsyncLocalStorage:AsyncLocalStorage})}function b(){return J().use().event}function $(e){return globalThis.MANIFEST[e]}const p="server-fn-return-type",l="server-fn-payload-type",V=eventHandler(M$1);async function M$1(e){return k(j(e))}async function k(e,n){var t,s;const a=e.method,h=new URL(e.url,"http://localhost:3000"),i=Object.fromEntries(new URLSearchParams(h.search).entries()),c=i._serverFnId,v=i._serverFnName;if(!c||!v)throw new Error("Invalid request");b$2(typeof c=="string","Invalid server action");const _=(s=await((t=$("server").chunks[c])==null?void 0:t.import()))==null?void 0:s[v],u=await(async()=>{try{const r=await(async()=>{var g;return e.headers.get(l)==="payload"?[a.toLowerCase()==="get"?(()=>{var f;return (f=defaultParseSearch(h.search))==null?void 0:f.payload})():await e.json(),{method:a,request:e}]:e.headers.get(l)==="formData"||(g=e.headers.get("Content-Type"))!=null&&g.includes("multipart/form-data")?[a.toLowerCase()==="get"?(()=>{const{_serverFnId:f,_serverFnName:D,payload:x}=i;return x})():await e.formData(),{method:a,request:e}]:e.headers.get(l)==="request"?[e,{method:a,request:e}]:await e.json()})(),o=await _(...r);return o instanceof Response?o:isRedirect$1(o)||isNotFound(o)?R(o):new Response(o!==void 0?JSON.stringify(o):void 0,{status:W$1(b()),headers:{"Content-Type":"application/json",[p]:"json"}})}catch(r){return r instanceof Response?r:isRedirect$1(r)||isNotFound(r)?R(r):(console.error("Server Fn Error!"),console.error(r),console.info(),new Response(JSON.stringify(r),{status:500,headers:{"Content-Type":"application/json",[p]:"error"}}))}})();if(u.headers.get("Content-Type")==="application/json"){const o=await u.clone().text();o&&JSON.stringify(JSON.parse(o));}return u}function R(e){const{headers:n,...t}=e;return new Response(JSON.stringify(t),{status:200,headers:{"Content-Type":"application/json",[p]:"json",...e.headers||{}}})}
  ...
  return H(t, (o, s) => {
    ...
    if (c) {
      ...
      if (n.push(u), c === "stream") {
        const [l, d] = o.tee();
        return u.streamState = ye({ stream: d }), l;
      } else
        defer$1(o);
    }
    return o;
...
function me(e) {
  ...
  return jsxs(Fragment, { children: [a !== void 0 || o !== void 0 || (n == null ? void 0 : n.length) ? jsx(ScriptOnce, { children: `__TSR__.matches[${e.matchIndex}] = ${R$1({ __beforeLoadContext: t.options.transformer.stringify(a), loaderData: t.options.transformer.stringify(o), extracted: n ? Object.fromEntries(n.map((s) => [s.id, pick(s, ["type", "path"])])) : {} }, { isScriptContext: true, wrap: true, json: true })}; __TSR__.initMatch(${e.matchIndex})` }) : null, n ? n.map((s, c) => s.type === "stream" ? jsx(he, { entry: s }, s.id) : jsx(fe, { entry: s }, s.id)) : null] });
}
function H(e, t, r = []) {
  if (isPlainArray(e))
...
function fe({ entry: e }) {
  return jsx("div", { className: "tsr-once", children: jsx(S$2.Suspense, { fallback: null, children: jsx(pe, { entry: e }) }) });
}
function pe({ entry: e }) {
  if (e.value.status === "pending")
    throw e.value;
  return jsx(ScriptOnce, { children: `__TSR__.matches[${e.matchIndex}].extracted[${e.id}].resolve(${R$1(e.value.data, { isScriptContext: true, wrap: true, json: true })})` });
}
function he({ entry: e }) {
  return b$2(e.streamState, "StreamState should be defined"), jsx(I, { streamState: e.streamState, children: (t) => jsx(ScriptOnce, { children: t ? `__TSR__.matches[${e.matchIndex}].extracted[${e.id}].value.controller.enqueue(new TextEncoder().encode(${R$1(t.toString(), { isScriptContext: true, wrap: true, json: true })}))` : `__TSR__.matches[${e.matchIndex}].extracted[${e.id}].value.controller.close()` }) });
}
function ye({ stream: e }) {
...
function I({ streamState: e, children: t, __index: r = 0 }) {
  ...
  if (n.status === "pending")
    throw n;
  const a = n.value;
  return jsxs(Fragment, { children: [t(a), jsx("div", { className: "tsr-once", children: jsx(S$2.Suspense, { fallback: null, children: jsx(I, { streamState: e, __index: r + 1, children: t }) }) })] });
}
function T(e, t, r) {
  if (t.length === 0)
    return r;
...
function C(e) {
  e.router.AfterEachMatch = me, e.router.serializer = (n) => R$1(n, { isScriptContext: true, wrap: true, json: true });
  const t = Context.get("TanStackRouterHydrationContext", {}), r = S$2.useMemo(() => {
    var n, a;
...
function ge(e) {
  var _a;
  return (_a = e.web) != null ? _a : e.web = { request: Se(e), url: A(e) }, e.web.request;
}
function _e() {
  return be();
}
...
function x(e) {
  return function(...t) {
    ...
    let r = t[0];
    if (Re(r))
      t[0] = r instanceof H3Event || r.__is_event__ ? r : r[P];
    else {
...
const St = x(getRequestHeaders), A = x(getRequestURL), gt = x(getResponseStatus), xe = x(getResponseHeaders), ve = x(getRequestWebStream);
function we() {
  var _a;
...
const Te = "server-fn-return-type", Ee = "server-fn-payload-type";
function Ce({ createRouter: e, getRouterManifest: t }) {
  return (r) => eventHandler(async (n) => {
    const a = ge(n), o = new URL(a.url), s = o.href.replace(o.origin, ""), c = createMemoryHistory({ initialEntries: [s] }), u = e();
    u.serializeLoaderData = de, t && (u.manifest = t()), u.update({ history: c }), await u.load();
...
function Me(e) {
  ...
  let t = M(xe(e.event), { "Content-Type": "text/html; charset=UTF-8" }, ...e.router.state.matches.map((n) => n.headers));
  const { redirect: r } = e.router.state;
  return r && (t = M(t, r.headers, { Location: r.href })), [Te, Ee].forEach((n) => {
    t.delete(n);
  }), t;
}
function $e(e) {
...
const ke = /(<body)/, Ie = /(<\/body>)/, Pe = /(<\/html>)/, Ae = /(<\/[a-zA-Z][\w:.-]*?>)/g, Le = new TextDecoder();
function L(e) {
  let t = false, r = "", n = "";
  return { async transform(a, o) {
    const s = r + Le.decode(a), c = s.match(ke), u = s.match(Ie), l = s.match(Pe);
    try {
      if (c && (t = true), !t) {
        o(s), r = "";
        return;
...
const Be = async ({ request: e, router: t, responseHeaders: r }) => {
  if (typeof v.renderToReadableStream == "function") {
    const n = await v.renderToReadableStream(jsx(C, { router: t }), { signal: e.signal, onError(s, c) {
      console.error(s, c);
    } });
    isbot(e.headers.get("User-Agent")) && await n.allReady;
    const o = [qe(t)].reduce((s, c) => s.pipeThrough(c), n);
    return new Response(o, { status: t.state.statusCode, headers: r });
  }
  if (typeof v.renderToPipeableStream == "function") {
    const n = new PassThrough(), a = v.renderToPipeableStream(jsx(C, { router: t }), { ...isbot(e.headers.get("User-Agent")) ? { onAllReady() {
      a.pipe(n);
    } } : { onShellReady() {
      a.pipe(n);
    } }, onShellError(c) {
      throw c;
    } }), s = [$e(t)].reduce((c, u) => c.pipe(u), n);
    return new Response(s, { status: t.state.statusCode, headers: r });
  }
  throw new Error("No renderToReadableStream or renderToPipeableStream found in react-dom/server. Ensure you are using a version of react-dom that supports streaming.");
}, De = () => ({ routes: { __root__: { filePath: "__root.tsx", children: ["/"], preloads: ["/_build/assets/client-_aV0kvq-.js", "/_build/assets/client-CeGHaAMR.js"] }, "/": { filePath: "index.tsx" } } });
function We(e) {
...
const Fe = () => {
  const e = useRouter(), t = useRouterState({ select: (o) => o.matches.map((s) => s.meta).filter(Boolean) }), r = S$2.useMemo(() => {
    const o = [], s = {};
    let c;
  ...
  const e = useRouter(), t = Fe(), r = S$2.useContext(Context.get("TanStackRouterHydrationContext", {}));
  return jsxs(Fragment, { children: [jsx("meta", { name: "tsr-meta" }), t.map((n, a) => createElement(B, { ...n, key: `tsr-meta-${JSON.stringify(n)}` })), jsxs(Fragment, { children: [jsx(ScriptOnce, { log: false, children: `
__TSR__ = {
  matches: [],
  streamedValues: {},
  initMatch: (index) => {
...
}` }), jsx(ScriptOnce, { children: `__TSR__.dehydrated = ${R$1(e.options.transformer.stringify(r), { isScriptContext: true, wrap: true, json: true })}` })] }), jsx("meta", { name: "/tsr-meta" })] });
}, ze = ({ children: e }) => {
  const t = useRouter(), r = Ne(), [n, a] = S$2.useState(false);
  S$2[typeof document < "u" ? "useLayoutEffect" : "useEffect"](() => {
...
const Ze = () => {
  ...
  return jsx(Fragment, { children: n.map((a, o) => createElement(B, { ...a, key: `tsr-scripts-${a.tag}-${o}` })) });
}, D = createRootRoute({ meta: () => [{ charSet: "utf-8" }, { name: "viewport", content: "width=device-width, initial-scale=1" }, { title: "TanStack Start Starter" }], component: Ke });
function Ke() {
  return jsx(Qe, { children: jsx(Outlet, {}) });
}
function Qe({ children: e }) {
  return jsxs(Ue, { children: [jsx(Ve, { children: jsx(ze, {}) }), jsxs(Ge, { children: [e, jsx(ScrollRestoration, {}), jsx(Ze, {})] })] });
}
const Xe = () => import('./build/index-VUlDrTel.mjs'), Ye = () => import('./build/index-VUlDrTel.mjs'), W = createFileRoute("/")({ component: lazyRouteComponent(Ye, "component", () => W.ssr), loader: lazyFn(Xe, "loader") }), et = W.update({ id: "/", path: "/", getParentRoute: () => D }), tt = { IndexRoute: et }, rt = D._addFileChildren(tt)._addFileTypes();
function nt() {
  return createRouter$2({ routeTree: rt });
}
const _t = Ce({ createRouter: nt, getRouterManifest: Oe })(Be);

const handlers = [
  { route: '/_server', handler: V, lazy: false, middleware: true, method: undefined },
  { route: '/', handler: _t, lazy: false, middleware: true, method: undefined }
];
...
export { Ee as E, St as S, Te as T, W, We as a, gt as b, be as c, eventHandler as e, ge as g, node$1 as n, vercel as v };
